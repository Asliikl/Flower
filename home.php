...
<section class="home">
   ...
   <div class="content">
      ...
      <p>Tüm zamanların en sevilen aranjmanları ile sevdiklerinizi mutlu edin.</p>
      <a href="about.php" class="btn-var">daha fazlasını keşfet</a>
   </div>
...
<section class="products">
   ...
   <?php
      ...
      FROM products
      INNER JOIN stock  ON stock.product_id=products.id WHERE stock.stok > 0 LIMIT 6") or die('query failed');
...
<section class="home-contact">
   ...
   <div class="content">
      <h3>Bir mesajınız var mı?</h3>
      <p></p>
      <a href="contact.php" class="btn">bizimle iletişime geçin</a>
   </div>
